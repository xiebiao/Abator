...
public final class Config extends Properties {
    ...
    private void init(InputStream input) throws IOException {
        ...
        this.load(input);
        try {
            defaultOutput = StringUtils.isEmpty(this.getProperty(ConfigKeys.OUTPUT)) ? defaultOutput : this
    ...
    private Connection getConnection() {
        try {
            Connection connection = DriverManager.getConnection(this.getProperty(ConfigKeys.DB_URL), this
                    .getProperty(ConfigKeys.DB_USER), this.getProperty(ConfigKeys.DB_PASSWORD));
            if (connection == null) {
