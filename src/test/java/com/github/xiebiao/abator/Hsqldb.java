 ...
 * <li><a href="http://hsqldb.org/doc/2.0/guide/dbproperties-chapt.html">HELP</a></li>
 * </ul>
 */
public class Hsqldb {
    ...
    try {
      InputStream input =
          Thread.currentThread().getContextClassLoader()
              .getResourceAsStream("script/create_table.sql");
      ...
      InputStream input2 =
          Thread.currentThread().getContextClassLoader().getResourceAsStream("script/inserts.sql");
  ...
  public Connection getConnection() throws SQLException {
    Connection conn =
        DriverManager.getConnection("jdbc:hsqldb:mem:" + databaseName
